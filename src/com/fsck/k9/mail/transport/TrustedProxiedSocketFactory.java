...
public class TrustedProxiedSocketFactory implements LayeredSocketFactory {
    private SSLSocketFactory mSocketFactory;
    private org.apache.http.conn.ssl.SSLSocketFactory mSchemeSocketFactory;

    public TrustedProxiedSocketFactory(String host, boolean secure) throws NoSuchAlgorithmException, KeyManagementException {
    ...
    public Socket createSocket() throws IOException {
        Socket sock = mSocketFactory.createSocket();
    ...
    public Socket createSocket(
        ...
        if (K9.getProxyManager() != null)
        {
        	...
        	K9.getProxyManager().connectSocketToProxy(sslSocket, new InetSocketAddress (host, port));
        }
